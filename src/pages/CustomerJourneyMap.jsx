    ...
    stages: [
      {
        ...
        painPoints: ['OTP might land in spam', 'Phone format confusion'],
        opportunities: ['Auto-detect country code', 'Inline OTP resend feedback'],
      },
      {
        name: 'Booking a Ride',
        icon: '📍',
        steps: [
          'Opens Passenger Dashboard — sees active driver count',
        ...
        touchpoints: ['Dashboard', 'New Request form', 'LocationSearchInput'],
      ...
      },
      {
        ...
        touchpoints: ['TripTracking page', 'Trip entity live polling', 'Leaflet map'],
        painPoints: ['No in-app chat', 'Driver location lags if GPS is weak'],
        opportunities: ['In-app messaging', 'Show driver route overlay'],
      },
      {
    ...
    stages: [
      {
        ...
        steps: [
          'Registers with full name, email, phone, and password',
          'Selects "Driver" role',
          'Chooses vehicle type (Keke, Okada, Car, Bus, Truck)',
          'Verifies email via OTP',
          'Completes profile with vehicle details (plate, model, colour, year)',
        ],
        touchpoints: ['Register page', 'OTP verification', 'VehicleDetailsSheet'],
      ...
      },
      {
        ...
        steps: [
          ...
          'Sees distance from their location to pickup',
          'Identifies already-bid requests (highlighted orange)',
          'Taps "Place Bid" on a chosen request',
        ],
        touchpoints: ['NearbyRequests page', 'Haversine distance calc', 'Request TTL countdown'],
        painPoints: ['No map view of requests', 'High-demand requests expire too fast'],
        opportunities: ['Map view toggle', 'Adjustable TTL or priority queue'],
      },
      {
        name: 'Placing a Bid',
        icon: '💸',
        steps: [
          ...
          'Enters bid price (naira)',
          'Optionally adds a message to the passenger',
          'ETA and current GPS location pre-filled automatically',
          'Submits bid',
        ],
        touchpoints: ['PlaceBid page', 'Bid entity', 'GPS location'],
        painPoints: ['No suggested price range', 'No knowledge of competing bids'],
        opportunities: ['Show market price hint', 'Show how many drivers have already bid'],
      },
      {
    ...
    stages: [
      {
        ...
        opportunities: ['Add a "Sender" sub-role or dedicated onboarding', 'Package profile presets'],
      },
      {
